            ...
            <div className="buying-container">
                ...
                {loading ? (
                    ...
                    <div className="buying-card">
                        <img src={fertilizer.image} alt={fertilizer.name} className="buying-image" />
                        <div className="buying-details">
                            <h3 className="buying-name">{fertilizer.name}</h3>
                            <p className="buying-price">&#8377; {fertilizer.price}</p>
                        </div>
                    </div>
                )}
...
export default FertilizerBuying;
