...
import FertilizerBuying from '../Products/FertilizersBuying';
import ProductsBuying from '../Products/ProductsBuying';
  ...
  return (
    <div className='App'>
      <Routes>
        ...
        <Route path="/fertilizer/:id/fertilizerbuying" element={<PrivateRoute element={<FertilizerBuying />} />} />
        <Route path="/product/:id/productbuying" element={<PrivateRoute element={<ProductsBuying />} />} />
        ...
        <Route path="/buyer/badd" element={<PrivateRoute element={<BuyerAdd />} />} />
        <Route path="/seller/sadd" element={<PrivateRoute element={<SellerAdd />} />} />
      </Routes>
    </div>
  );
}
